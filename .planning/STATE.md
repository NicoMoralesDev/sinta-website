...
**Current focus:** Phase 1 - Results Contract And Schema

## Current Position

Phase: 1 of 5 (Results Contract And Schema)
Plan: 0 of TBD in current phase
Status: Ready to plan
Last activity: 2026-04-02 — Roadmap created and v1 requirement traceability mapped.
...
- Phase 1: Treat `qualy` as an optional extension of the existing results contract.
- Phase 3: Hide `qualy` wherever the event has no recorded qualifying data.
...
- Phase 1: Confirm the safest Postgres migration path for extending result-session support to `qualy`.
